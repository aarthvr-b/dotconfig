...
vks("n", "<Esc>", ":nohlsearch<CR>", { desc = "Clear search highlights" })

-- Visual Keymaps
vks("v", "<leader>rh", '"hy:%s/<C-r>h//g<left><left>', { desc = "Find and replace selected text" }) -- In Visual mode find and replace selected section
